    ...
    addEntry: function addEntry(entry) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this.cn.addNode({
          ...
          var allTokenNodes = [];
          var tokenizer = new _sentenceTokenizer2.default(_this.user, _this.name);
          ...
          var sentencesNodes = _this.cn.addNodes(sentencesObjects);
          _this.lastSentenceNodeId = sentencesNodes[sentencesNodes.length - 1].id;
