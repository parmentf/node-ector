...
function Ector() {
  var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'ECTOR';
  var username = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'Guy';
  ...
  var ector = {
    ...
    createTokens: function createTokens(sentence, index, tokenizer) {
      ...
      return tokens.reduce(function (sequence, token, index) {
        return _this.cn.getNode({ label: token, type: 'w' }).then(function () {
          var oldToken = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { beg: 0, mid: 0, end: 0 };
    ...
    addEntry: function addEntry(entry) {
      ...
      var cns = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.cns[this.user];
