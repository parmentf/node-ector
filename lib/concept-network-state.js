  ...
  var cns = {
    ...
    computeInfluence: function computeInfluence() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        var promise = _this7.cn.node.reduce(function (sequence, node, nodeId) {
          return sequence.then(function () {
            var ov = void 0; // acrobatic
            _this7.getOldActivationValue(node).then(function (oav) {
              ov = oav; // acrobatic
              return _this7.cn.getNodeFromLinks(nodeId);
            }).then(function (outgoingLinks) {
              return outgoingLinks.reduce(function (sequence, linkId) {
                return sequence.then(function () {
                  _this7.cn.getLink(linkId).then(function (link) {
                    debug('link', link);
                    debug('ov', ov);
